...
const EditNonMemDialog = ({
  ...
  const handleSubmit = async () => {
    ...
    if (!nameError && !phoneError) {
      try {
        await api.put(`/customer/edit-non-mem-cus/${selectedItem.id}`, {
          name: formData.name,
...
export default EditNonMemDialog;
