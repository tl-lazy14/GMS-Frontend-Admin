...
const EditPTPackage = ({
  ...
  useEffect(() => {
    if (selectedPackage) {
      setFormData({
        ...
        numSessions: selectedPackage.numSessions,
  ...
  const handleSubmit = async () => {
    ...
    if (!nameError && !durationError && !numSessionsError && !priceError) {
      try {
        await api.put(`/service/edit-pt-package/${selectedPackage.id}`, {
          name: formData.name,
